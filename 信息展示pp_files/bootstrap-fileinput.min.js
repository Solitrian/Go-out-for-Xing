...
(function ($) {
    ...
    $.fn.fileinput.locales.es = {
            ...
            uploadLabel: '上传',
            uploadTitle: '上传选中文件',
            msgSizeTooLarge: '文件 "{name}" (<b>{size} KB</b>) 超过允许上传的最大大小 <b>{maxSize} KB</b>。请重新上传！',
            msgFilesTooLess: '文件数量必须大于 <b>{n}</b> {files} ，请重新上传！',
            msgFilesTooMany: '选择上传的文件数量 <b>({n})</b> 超过允许的最大限度 <b>{m}</b>。请重新上传！',
            msgFileNotFound: '文件 "{name}" 未找到!',
            msgFileSecured: '安全限制阻止读取文件 "{name}"。',
            msgFileNotReadable: '文件 "{name}" 不可读。',
            msgFilePreviewAborted: ' "{name}" 文件预览中止。',
            ...
            msgProgress: '正在加载文件 {index} {files} - {name} - {percent}% 已完成。',
            msgSelected: '选中{n}个文件',
            msgFoldersNotAllowed: '只拖放文件！删除了 {n} 个丢弃的文件夹。',
            dropZoneTitle: '将文件拖放到此处&hellip;'
    };
